...
- `support_categories` - категории тех. поддержки.
- `support_categories_layout` - расположение кнопок при выборе категории поддержки, указывается как список строк, которые являются списками индексов категорий.
